It is simple weather app made with <b>open weather API</b>. It shows the current weather condition of searched place with dynamic background that changes based on weather condition.
